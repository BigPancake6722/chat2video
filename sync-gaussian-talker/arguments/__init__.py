...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.attn_reg_from_iter = 6000
        self.coarse_surface_reg_from_iter = 4000
        self.batch_size=1
...
def get_combined_args(parser : ArgumentParser, custom_cmd_list=None):
    cmdlne_string = sys.argv[1:] if custom_cmd_list==None else custom_cmd_list
