...
import torch
import numpy as np
from utils_talker.general_utils import inverse_sigmoid, get_expon_lr_func, build_rotation
from torch import nn
import os
import open3d as o3d
from utils_talker.system_utils import mkdir_p
from plyfile import PlyData, PlyElement
from random import randint
from utils_talker.sh_utils import RGB2SH
from simple_knn._C import distCUDA2
from utils_talker.graphics_utils import BasicPointCloud
from utils_talker.general_utils import strip_symmetric, build_scaling_rotation
from scene.deformation import deform_network
from scene.regulation import compute_plane_smoothness
from utils_talker.point_utils import downsample_point_cloud_open3d, addpoint, find_indices_in_A, combine_pointcloud
...
class GaussianModel:
    ...
    def restore(self, model_args, training_args):
        ...
        self.denom = denom
        self._deformation.load_state_dict(deformation_dict, strict=False)
        try:
            self.optimizer.load_state_dict(opt_dict)
        except:
            print("could not load optimizer from tate dict, use default params")
