...
"""
custom:
  bert_base_path: chat2audio/tts/GPT_SoVITS/pretrained_models/chinese-roberta-wwm-ext-large
  cnhuhbert_base_path: chat2audio/tts/GPT_SoVITS/pretrained_models/chinese-hubert-base
  device: cpu
  is_half: false
  t2s_weights_path: chat2audio/tts/GPT_SoVITS/pretrained_models/gsv-v2final-pretrained/s1bert25hz-5kh-longer-epoch=12-step=369668.ckpt
  vits_weights_path: chat2audio/tts/GPT_SoVITS/pretrained_models/gsv-v2final-pretrained/s2G2333k.pth
  version: v2
default:
  bert_base_path: chat2audio/tts/GPT_SoVITS/pretrained_models/chinese-roberta-wwm-ext-large
  cnhuhbert_base_path: chat2audio/tts/GPT_SoVITS/pretrained_models/chinese-hubert-base
  device: cpu
  is_half: false
  t2s_weights_path: chat2audio/tts/GPT_SoVITS/pretrained_models/s1bert25hz-2kh-longer-epoch=68e-step=50232.ckpt
  vits_weights_path: chat2audio/tts/GPT_SoVITS/pretrained_models/s2G488k.pth
  version: v1
default_v2:
  bert_base_path: chat2audio/tts/GPT_SoVITS/pretrained_models/chinese-roberta-wwm-ext-large
  cnhuhbert_base_path: chat2audio/tts/GPT_SoVITS/pretrained_models/chinese-hubert-base
  ...
  version: v2
"""
base_path = "/root/chat2video/chat2audio/tts/GPT_SoVITS" # 模型主题文件基地址
...
class TTS_Config:
    default_configs={
        "default":{
                ...
                "is_half": False,
                "version": "v1",
                "t2s_weights_path": f"{base_path}/pretrained_models/s1bert25hz-2kh-longer-epoch=68e-step=50232.ckpt",
                "vits_weights_path": f"{base_path}/pretrained_models/s2G488k.pth",
                "cnhuhbert_base_path": f"{base_path}/pretrained_models/chinese-hubert-base",
                "bert_base_path": f"{base_path}/pretrained_models/chinese-roberta-wwm-ext-large",
            },
        "default_v2":{
                "device": "cpu",
                "is_half": False,
                "version": "v2",
                "t2s_weights_path": f"{base_path}/pretrained_models/gsv-v2final-pretrained/s1bert25hz-5kh-longer-epoch=12-step=369668.ckpt",
                "vits_weights_path": f"{base_path}/pretrained_models/gsv-v2final-pretrained/s2G2333k.pth",
                "cnhuhbert_base_path": f"{base_path}/pretrained_models/chinese-hubert-base",
                "bert_base_path": f"{base_path}/pretrained_models/chinese-roberta-wwm-ext-large",
            },
    }
    ...
    def __init__(self, configs: Union[dict, str]=None):
        ...
        # 设置默认配置文件路径
        configs_base_path:str = f"{base_path}/configs/"
